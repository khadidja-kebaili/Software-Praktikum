...
class Studentprofile(BusinessObject):
    ...
    def __str__(self):
        ...
        return "Profile: {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}".format(self.get_last_name(), self.get_first_name(), self.get_age(), self.get_semester(), self.get_major(), self.get_hobbys(), self.get_interests(), self.get_personality(), self.get_studyplace(), self.get_studytime(), self.get_studyfrequence(), self.get_learnstyle(), self.get_workexperience(), self.get_requested_by())
    ...
    def from_dict(dictionary=dict()):
        ...
        obj.set_request(dictionary["request"])
        return obj