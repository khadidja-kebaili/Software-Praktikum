...
#
#
# score = api.model('Scores', {
#     "Score" : fields.Integer(attribute = "score", description = "score")
# })
#
# profileII = api.inherit('Profil', bo, {
#     'first_name': fields.String(attribute='first_name', description='first_name'),
#     'last_name': fields.String(attribute='last_name', description='last_name'),
#     'age': fields.Integer(attribute='age', description='age'),
#     'semester': fields.Integer(attribute='semester', description='semester'),
...
#             scores.append(adm.set_score(element, element + 1))
#         for element in adm.get_all_profiles():
#             new_match = {"Profile": adm.get_profile_by_id(element.get_id()), 'Score': adm.set_score(id, element.get_id())}
