...
class MatchForm extends Component {
    constructor(props){
        ...
        updateMatches = () => {
            ...
            LernappAPI.getAPI().upsateMatches(updateMatches).then(matches => {
                this.setState({
                    updatingInProgress: false,
                    updatingError: null
                });
    ...
    this.render(){
        ...
        const{firstName, firstNameValidationFailed, firstNameEdited, lastName, lastNameValidationFailed, lastNameEdited, id, idValidationFailed,addingInProgress,
           ...
           <DialogContent>
               ...
               <form className={classes.root} noValidate autoComplete='off'>
                   <TextField autoFocus type='text'required fullWidth margin='normal' id='firstName' label='First name:' value={firstName} 
                    ...
                    onChange={this.textFieldValueChange} error={lastNameValidationFailed}
                    helperText={lastNameValidationFailed ? 'The ID must contain at least one character' : ' '} />  
               </form>
