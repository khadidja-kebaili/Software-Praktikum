...
group = api.inherit('Group', bo, {
    ...
    'description': fields.Integer(attribute='description', description='description'),
    'groupname': fields.Integer(attribute='groupname', description='groupname'),
    })
...
class Gruppe (Resource):
    ...
    def post(self):
        adm = Businesslogik()
        proposal = GroupMapper.from_dict(api.payload)
        # //Notiz Daten von Frontend werden in proposal gespeichert
        if proposal is not None:
