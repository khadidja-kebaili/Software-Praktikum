class Participant(object):
    ...
    industry_weight = 1
    geography_weight = 1
    # vorkenntnisse_weight = 1


    def __init__(self, item=None, industry_weight=None, geography_weight=None, *args, **kwargs):
    ...
    def __str__(self):
        return "[type=%s id=%s geography_ids=%s industry_ids=%s]" % (
        self.type, self._id, self.geography_ids, self.industry_ids)

    def __repr__(self):
        return self._id

    def match(self, possible_matches, industry_weight=None, geography_weight=None):
        """
